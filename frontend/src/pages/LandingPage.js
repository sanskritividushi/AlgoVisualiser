...
const LandingPage = ({ handleSort, generateRandomArray, setSpeed, speed }) => {
    return (
      <div>
        <div className="background"></div>
           <div class="container">
        <div class="header"> 
            <span class="name"><b>ARRAY SORTING ALGORITHMS</b></span>
        </div>
        <div class="choose"><h2>Choose Algorithm</h2></div>
